							...
							<h:form>
								<div id="TEXT">
									...
									<h:panelGrid columns="2">
										...
										<h:outputText id="emissora"
											value="#{materiaBean.materiaEdit.emissora }"></h:outputText>
										...
										<h:outputText id="resumo"
											value="#{materiaBean.materiaEdit.indice }"></h:outputText>


									</h:panelGrid>
									<script>
										function assistirVideo() {
											document.getElementById("myFrame").src = "upload/video/${materiaBean.materiaEdit.nomeDoArquivo}";
									...
									<video id="myFrame" width="0" controls="controls"> <source
										src="" type="video/mp4"></video>

									<br />
									<br />
									<!--<input type="button"  onclick="assistirVídeo();" value="Vídeo"></input>
									 -->
									<button type="button" class="btn btn-primary"
										onclick="assistirVideo();">Atualizar/Carregar Vídeo</button>
									<br />
									<br />

									<h:commandButton id="solicitarMateria"
										value="Solicitar Materia"
										action="#{materiaBean.salvarHasMateriaSolicitacao }">
									</h:commandButton>
