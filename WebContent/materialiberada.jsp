...
<div id="heading">
				<div class="head"></div>
<div class="top">
				<a href="cadastrousuario.jsf"> Cadastrar usuário</a><a href="boss.jsf">busca matéria</a><a href="arquivo.jsf">Cadastrar Matéria</a></div>
		   e</div>
		</div>
	</div>
...
<h:selectManyCheckbox value="#{materiaBean.usuariosLiberados }" layout="pageDirection">

<f:selectItems value="#{usuarioBean.usuarioNome }" />

</h:selectManyCheckbox>

<h:commandButton id="liberarMateria" value="Liberar" action="#{materiaBean.salvarLiberarHasMateria}" > </h:commandButton>
