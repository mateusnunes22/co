							...
							<h:form>
								<div id="TEXT">
									...
									<rich:fileUpload id="upload" maxFilesQuantity="1"
										required="true" immediateUpload="true"
										requiredMessage="Selecione um arquivo" listHeight="80"
										listWidth="500"
										fileUploadListener="#{materiaBean.fileUploadListener }" />
										
										<audio id="myAudio" controls="controls"> <source
										src="upload/audio/${materiaBean.nomeArquivo}" type="audio/mp3" /> </audio>
									<script>
									function ouvirAudio() {
										document.getElementById("myAudio").src = "upload/audio/${materiaBean.nomeArquivo}";
									}
									</script>
									<br />
									<button class="btn btn-primary" onclick="ouvirAudio()">Carregar Áudio</button>
									<a4j:loadScript src="Scripts/jquery.maskedinput.js">
										<h:panelGrid columns="2">
											...
											<h:outputText value="Nome do rádio"></h:outputText>

											<h:selectOneMenu id="numeroUsuario"
												value="#{materiaBean.materia.nomePrograma }">
												<f:selectItems value="#{graficoBean.radio }" />
											</h:selectOneMenu>
